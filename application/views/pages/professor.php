...
<body>
	...
	<div class="modal fade" id="insert_professor">
	  <div class="modal-dialog modal-md">
			<div class="modal-content">
				...
				<form action="<?php echo site_url('movepage/insert_professor')?>" method="post" id="add-people" enctype="multipart/form-data">
				<div class="modal-body">
    ...
    <div class="container">
		<div>
			<div class="col-lg-6" style="padding-top:15px;">
				<button  data-toggle="modal" data-target="#insert_professor" type="submit" class="btn btn-primary btn-md">Add Name</button>
			</div>
			<div class="col-lg-6">
        ...
        <div>
			<form id="professor-search-form" method="POST" action="<?php echo base_url();?>rate-my-professor">
				<div class="col-md-12">
					<div class="form-group">
						<input type="text" name="search_name" id="professor_auto_complete" class="form-control input-lg" placeholder="Search For Name" value="<?php if(isset($_POST['search_name'])){echo $_POST['search_name']; }?>">
					</div>
				</div>
			</form>
			<br><br><br>
			...
			<?php foreach ($people_data as $row) { ?>
				...
				<div class="col-md-6 col-md-offset-5">
					<ul style="list-style-type: square; margin-top: -170px; margin-left:230px">
					  <li class="name_class" style="font-size: 18px !important;"> <?php echo $row['question1'];?> professor</li>
		...
		<div class="col-lg-12 text-center" style="margin-bottom:20px ;">
			<button data-toggle="modal" data-target="#insert_professor" type="submit" class="btn btn-primary btn-sm ">Add Name</button>
		...
		<div class="col-lg-12 text-center">
			<br>
			<button data-toggle="modal" data-target="#insert_professor" type="submit" class="btn btn-primary btn-lg ">Add Name</button>
		</div>
