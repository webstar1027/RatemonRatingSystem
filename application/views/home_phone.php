...
<head>
	...
	<link href="<?php echo asset_dir();?>css/jquery.auto-complete.css" rel="stylesheet" >
...
<body>
    ...
    <div class="container">
		<button data-toggle="modal" data-target="#insert_person" type="submit" class="btn btn-primary btn-md">Add Name</button>
        ...
        <div>
			<form id="people-search-form" method="POST" action="<?php echo base_url();?>home">
				<div class="col-md-12">
					<div class="form-group">
						<input type="text" name="search_name" id="people_auto_complete" class="form-control input-lg" placeholder="Search For Name" value="<?php if(isset($_POST['search_name'])){echo $_POST['search_name']; }?>">
					</div>
				</div>
			</form>
			<br>
        ...
        <div class="col-md-12">
			<?php foreach ($people_data as $row) { ?>
				<div class="col-md-12 thumbnail" >
					<div class="col-md-12 text-center" style="margin-bottom:20px ;"><img <?php if(is_null($row['picture'])){ echo 'class="img-responsive"'; }?> src="<?php echo asset_dir(); ?>images/<?php if(is_null($row['picture'])){ echo 'default.jpg'; }else{ echo $row['picture']; } ?>" alt="Lights" /></div>
					<div class="col-md-12">
						...
						<?php if(strlen($row["last_comment"]) > 0){ ?>
							<div class="col-md-12">
								<span><?php if(strlen($row["last_comment"]) > 80){ echo substr($row["last_comment"],0 , 80).'...'; }else{ echo $row["last_comment"]; }  ?>
							</div>
							<div class="col-md-12">
		...
		<div class="col-lg-12 text-center" style="margin-bottom:20px ;">
			<button data-toggle="modal" data-target="#insert_person" type="submit" class="btn btn-primary btn-sm ">Add Name</button>
		...
		<div class="col-lg-12 text-center">
			<br>
			<button data-toggle="modal" data-target="#insert_person" type="submit" class="btn btn-primary btn-lg ">Add Name</button>
		</div>
